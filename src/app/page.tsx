    ...
    <div className="relative min-h-[100dvh] bg-app-background">
      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4">
        ...
        <div className="mt-10 pb-12">
          <div className="app-reveal text-center rounded-3xl bg-app-card p-5 shadow-[0_14px_30px_rgba(148,163,184,0.16)] ring-1 ring-app-card-border backdrop-blur sm:p-6">
            ...
            <div className="mt-2 text-sm leading-7 text-app-muted">
              ...
              garden. This simple stimulation will help you focus more. Give it a try.
            </div>
          </div>
        </div>
      </main>
